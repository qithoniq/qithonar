...
async def iq(iqthon):
    ...
    await LLL5L[0].click(
        ...
        hide_via=True)
@qithon.on(admin_cmd(pattern="همسه ?(.*)"))
async def iq(iqthon):
    if iqthon.fwd_from:
        return
    ...
    await iqthon.delete()
@qithon.on(admin_cmd(pattern="حالتي ?(.*)"))
async def iq(iqthon):
...
@qithon.on(admin_cmd(pattern="بي دي اف ?(.*)"))
async def _(iqthon):
...
@qithon.on(admin_cmd(pattern="بوتي$"))
async def iq(iqbot):
    TG_BOT_USERNAME = Config.TG_BOT_USERNAME
    await iqbot.reply(f"**بوت جيثون الخاص بك : {TG_BOT_USERNAME}**")
@qithon.on(admin_cmd(pattern="ملصقي ?(.*)"))
async def iq(iqthon):
    if iqthon.fwd_from:
        return
    if not iqthon.reply_to_msg_id:
...
@qithon.on(admin_cmd(pattern="اسم الاغنيه ?(.*)"))
async def iq(iqthon):
    if not iqthon.reply_to_msg_id:
    ...
    try:
        ...
        return await iqthon.edit(            "**هناك خطا نعتذر**")
@qithon.on(admin_cmd(pattern="انشاء بريد(?: |$)(.*)"))
async def _(iqthon):
    chat = "@TempMailBot"
...
@qithon.on(admin_cmd(pattern="سجل الاسماء(ألف)?(?:\s|$)([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern="تيك توك(?: |$)(.*)"))
async def _(iqthon):
    reply_message = await iqthon.get_reply_message()
...
@qithon.on(admin_cmd(pattern="زخرفه_عربي ?(.*)"))
async def _(event):
...
@qithon.on(admin_cmd(pattern="زخرفه_انكليزي ?(.*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
    reply_to_id = await reply_id(event)
    if event.reply_to_msg_id:
    ...
    async with event.client.conversation(chat) as conv:
        ...
        if response.text.startswith("رجاء قم بالرد على الكلمه التي تريد زخرفتها "):
            ...
            await catevent.delete()
            await event.client.send_message(event.chat_id, response.message)
@qithon.on(admin_cmd(pattern="انستا (.*)"))
...
async def iq(iqthon):
    ...
    await l5[0].click(iqthon.chat_id)
    await iqthon.delete()
@qithon.on(admin_cmd(pattern="كشف الفايروسات( -i)?$"))    
