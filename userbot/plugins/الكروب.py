...
@qithon.on(admin_cmd(pattern=f"{MUTE}(?:\s|$)([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern=f"{UNMUTE}(?:\s|$)([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern=r"المشرفين(?: |$)(.*)"))
async def _(event):
...
@qithon.on(admin_cmd(pattern=r"البوتات?(.*)"))
async def _(event):
...
@quthon.on(admin_cmd(pattern=r"الأعضاء(?: |$)(.*)"))
...
@qithon.on(admin_cmd(pattern=r"معلومات(?: |$)(.*)"))
...
@qithon.on(admin_cmd(pattern=f"{addition} ?(.*)"))
async def iq(event):
...
@qithon.on(admin_cmd(pattern=f"{TFLASH}(.*)"))
async def _(event):
...
@qithon.on(admin_cmd(pattern=f"{LEFT}(.*)"))
async def kickme(leave):
    await leave.edit("**♛ ⦙   جـاري مـغادرة المجـموعة مـع السـلامة  🚶‍♂️  ..**")
    await leave.client.kick_participant(leave.chat_id, "me")

@qithon.on(admin_cmd(pattern=f"{REMOVEBAN}(.*)"))
async def _(event):
...
@qithon.on(admin_cmd(pattern=f"المحذوفين ?([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern=r"احصائيات الاعضاء ?([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern="تقيد(?:\s|$)([\s\S]*)",))
async def endmute(event):
    user, reason = await get_user_from_event(event)
    if not user:
        return
...
@qithon.iq_cmd(pattern="اكتم(?:\s|$)([\s\S]*)",)
...
@qithon.on(admin_cmd(pattern=r"احظر(?:\s|$)([\s\S]*)",))
...
@qithon.on(admin_cmd(pattern=r"حظر عام(?:\s|$)([\s\S]*)",))
...
@qithon.on(admin_cmd(pattern=r"الغاء حظر العام(?:\s|$)([\s\S]*)",))
...
@qithon.on(admin_cmd(pattern=r"المحظورين عام$",))
async def gablist(event):
    gbanned_users = gban_sql.get_all_gbanned()
    GBANNED_LIST = "Current Gbanned Users\n"
    if len(gbanned_users) > 0:
...
@qithon.on(admin_cmd(pattern=r"معلومات تخزين المجموعه(?:\s|$)([\s\S]*)"))
async def _(event):  # sourcery no-metrics
    reply = await event.get_reply_message()
    input_str = event.pattern_match.group(1)
...
@qithon.iq_cmd(incoming=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@qithon.iq_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
@qithon.on(admin_cmd(pattern=r"تخزين الخاص (تشغيل|ايقاف)$"))
...
@qithon.on(admin_cmd(pattern=r"تخزين الكروبات (تشغيل|ايقاف)$"))
...
@qithon.on(admin_cmd(pattern=f"{LINKK} ?(.*)"))
async def iq(SLQ):
...
@qithon.on(admin_cmd(pattern="عدد رسائلي ?(.*)"))
async def iq(SLQ):
...
@qithon.on(admin_cmd(pattern="تغير صورة( المجموعة| -d)$"))
...
@qithon.on(admin_cmd(pattern=f"{UNADMINRAISE}(?: |$)(.*)"))
...
@qithon.on(admin_cmd(pattern="الغاء التثبيت(?: |$)(.*)"))
async def pin(event):
...
@qithon.on(admin_cmd(pattern="جلب الاحداث(?: |$)(.*)"))
...
moment_worker = []
@qithon.on(admin_cmd(outgoing=True, pattern="all?(.*)"))
...
@qithon.on(admin_cmd(outgoing=True, pattern="ايقاف التاك?(.*)"))
...
@qithon.on(admin_cmd(pattern=f"{BANDD}(?: |$)(.*)"))
...
@qithon.on(admin_cmd(pattern=r"zip(?:\s|$)([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern=r"unzip(?:\s|$)([\s\S]*)"))
...
@qithon.on(admin_cmd(pattern="معرفه(?: |$)(.*)"))
...
@qithon.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@qithon.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
@qithon.on(admin_cmd(pattern=f"{UNBANDD}(?: |$)(.*)"))
...
async def watcher(event):
    if is_muted(event.sender_id, event.chat_id):
        try:
            ...
            LOGS.info(str(e))
@qithon.on(admin_cmd(pattern="صنع (مجموعه|قناه) (.*)"))
async def iq(event):
    type_of_group = event.pattern_match.group(1)
    group_name = event.pattern_match.group(2)
    if type_of_group == "قناه":
        descript = "♛ ⦙   هذه قناة إختبار أُنشئت بإستعمال جيبثون العرب"
    else:
        descript = "♛ ⦙   هذه المجموعه إختبار أُنشئت بإستعمال جيبثون العرب"
...
@qithon.on(admin_cmd(pattern="تلقائي ?(.*)"))
async def _(event):
...
@qithon.on(admin_cmd(pattern="الغاء_التلقائي ?(.*)"))
async def _(event):
    if (event.is_private or event.is_group):
        return await edit_or_reply(event, "امر التلقائي يستخدم فقط للقنوات.")
    hel_ = event.pattern_match.group(1)
...
@qithon.on(admin_cmd(pattern=r"جلب الصور(?:\s|$)([\s\S]*)"))
async def potocmd(event):
    ...
    if uid.strip() == "":
        ...
        await event.client.send_file(event.chat_id, send_photos)
    await event.delete()
@qithon.on(admin_cmd(pattern="تفعيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
...
@qithon.on(admin_cmd(pattern="تعطيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
    peer_id = event.chat_id
    if not event.is_group:
...
@qithon.on(admin_cmd(pattern="صلاحيات المجموعه$"))    
async def _(event):  
    res = ""
