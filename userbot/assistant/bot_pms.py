    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا اخوي  {mention} **\
                        ...
                        \n\n**⌔︙ البوت خاص بسورس :** [QITHON FOR Arabs ](https://t.me/QITHON)"
        buttons = [
            (
                Button.url("تنصيب سورسنا", "https://heroku.com/deploy?template=https://github.com/qithoniq/T-"),
                Button.url(
                    "قناه المساعد",
                    "https://t.me/QITHON",
                ),
...
@qithon.bot_cmd(incoming=True, func=lambda e: e.is_private)
...
@qithon.tgbot.on(CallbackQuery(data=re.compile(b"bot_pm_ban_([0-9]+)")))
@check_owner
...
@qithon.tgbot.on(CallbackQuery(data=re.compile(b"toggle_bot-antiflood_off$")))
@check_owner
...
@qithon.bot_cmd(incoming=True, func=lambda e: e.is_private)
@qithon.bot_cmd(edited=True, func=lambda e: e.is_private)
